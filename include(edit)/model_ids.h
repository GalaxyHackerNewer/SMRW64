...
// actor model IDs
#define MODEL_SATELLITEPLUMBER                    0x3B       //satelliteplumber_geo
...
//pgy
#define MODEL_SATELLITEPLUMBER 0xE4 //satelliteplumber_geo
#define MODEL_SKINNED 0xE5//skinned_geo
